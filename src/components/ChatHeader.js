...
function ChatHeader(props) {
  ...
  return (
    <div class="row mx-0 py-2 bg-blue-500 sm:bg-gray-400">
          ...
          <div class="col-md-12 col-sm-12 col-12 px-0">
            <div class="dropdown">
              <i
                ...
                class="fa fa-ellipsis-v text-xl px-2 hover:bg-gray-200 hover:text-gray-800 rounded-full py-1 px-2"
                aria-hidden="true"></i>
              <div
                id="myDropdown"
                class="dropdown-content bg-gray-200 shadow rounded-lg p-2 mt-1">
                <div class="row m-0 text-md">
                  <div
